    ...
    <div class="row d-flex justify-content-center">
        <div class="col-xl-7 col-lg-8 col-md-9 col-sm-11">
            <div class="card border-0">
				...
				<form action="<?= URL_ROOT.'/users/payment_card'?>" method="post">
                <div class="row">
                    <div class="col-sm-7 border-line pb-3">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row px-3">
                                <input type="text" name="number" placeholder="0000 0000 0000 0000" size="18" id="cr_no" minlength="19" maxlength="19">
                                <p class="mb-0 ml-3">/</p>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="date_card" placeholder="MM/YY" size="6" id="exp" minlength="5" maxlength="5">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group mb-0">
                            <div class="custom-control custom-checkbox custom-control-inline">
                                <input id="chk1" type="checkbox" name="" class="custom-control-input" checked> 
                    ...
                    <div class="col-sm-5 text-sm-center justify-content-center pt-4 pb-4">
                        ...
                        <div class="row px-3 justify-content-sm-center">
                            <h2 class=""><span class="text-md font-weight-bold mr-2">$</span><span class="text-danger"> <?= get_session('total_price') ?> </span></h2>
                        </div>
                        <button type="submit" class="btn btn-red text-center mt-4">PAY</button>
                    </div>
					<div class = "mt-2">
						<?= (get_session('msg_card')) ? get_session('msg_card') : ''; ?>
					</div>
                </div>
			</form>
            </div>
